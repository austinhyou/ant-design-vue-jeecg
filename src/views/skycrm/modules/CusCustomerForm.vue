        ...
        <a-row>
          <a-col :span="24">
            <a-form-item label="顧客ID" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['cusId', validatorRules.cusId]" placeholder="请输入顧客ID"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="顧客名" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['cusName', validatorRules.cusName]" placeholder="请输入顧客名"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="顧客級別" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['cusSen']" :trigger-change="true" dictCode="" placeholder="请选择顧客級別"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules: {
          cusId: {
            rules: [
              { required: true, message: '请输入顧客ID!'},
            ]
          },
          cusName: {
            rules: [
              { required: true, message: '请输入顧客名!'},
            ]
          },
        },
        url: {
          add: "/ko/cusCustomer/add",
          edit: "/ko/cusCustomer/edit",
          queryById: "/ko/cusCustomer/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'cusId','cusName','cusAddress','cusPername','cusPhonenum','cusSort','cusSen','cusType','cusHeadline','cusMemos'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'cusId','cusName','cusAddress','cusPername','cusPhonenum','cusSort','cusSen','cusType','cusHeadline','cusMemos'))
      },
    }
  }
</script>
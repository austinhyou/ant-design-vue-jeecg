    ...
    <j-form-container :disabled="formDisabled">
      <a-form :form="form" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="支払完了" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['conAr']" placeholder="请输入支払完了"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="審査" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['conReview']" placeholder="请输入審査"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">

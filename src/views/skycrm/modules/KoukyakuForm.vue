        ...
        <a-row>
          <a-col :span="24">
            <a-form-item label="顧客ID" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['cusId']" placeholder="请输入顧客ID" style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="電話番号" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['cusPhonenum', validatorRules.cusPhonenum]" placeholder="请输入電話番号"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="項目分類" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['cusSort']" placeholder="请输入項目分類"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="項目内容" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['cusHeadline']" :trigger-change="true" dictCode="" placeholder="请选择項目内容"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="備考" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea v-decorator="['cusMemos']" rows="4" placeholder="请输入備考"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/ko/koukyaku/add",
          edit: "/ko/koukyaku/edit",
          queryById: "/ko/koukyaku/queryById"
        }
      }
    },
    computed: {

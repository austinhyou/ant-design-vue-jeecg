<template>
  <a-card :bordered="false">
    ...
    <koukyaku-modal ref="modalForm" @ok="modalFormOk"></koukyaku-modal>
  </a-card>
</template>
...
<script>
  ...
  import KoukyakuModal from './modules/KoukyakuModal'
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'項目内容',
            align:"center",
            dataIndex: 'cusHeadline_dictText'
          },
          {
            title:'備考',
            align:"center",
        ...
        url: {
          list: "/ko/koukyaku/list",
          delete: "/ko/koukyaku/delete",
          deleteBatch: "/ko/koukyaku/deleteBatch",
          exportXlsUrl: "/ko/koukyaku/exportXls",
          importExcelUrl: "ko/koukyaku/importExcel",

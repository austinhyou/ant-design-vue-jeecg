  ...
  <div class="page-header-index-wide">
    <a-row :gutter="24">
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="インデックスの説明" :total="cardCount.sll | NumberFormat">
          <a-tooltip title="インデックスの説明" slot="action">
      ...
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="決済金額" :total="cardCount.bjl | NumberFormat">
          <a-tooltip title="インデックスの説明" slot="action">
            <a-icon type="info-circle-o" />
          </a-tooltip>
          <div>
          ...
          <template slot="footer">今日決済金額：<span>{{ todayBjl }}</span></template>
        </chart-card>
      </a-col>
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="ユーザー受理量" :total="cardCount.isll | NumberFormat">
          <a-tooltip title="インデックスの説明" slot="action">
            <a-icon type="info-circle-o" />
          </a-tooltip>
          <div>
          ...
          <template slot="footer">今日ユーザー受理量：<span>{{ todayISll }}</span></template>
        </chart-card>
      </a-col>
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="ユーザー決済金額" :total="cardCount.ibjl | NumberFormat">
          <a-tooltip title="インデックスの説明" slot="action">
            <a-icon type="info-circle-o" />
          </a-tooltip>
          <div>
          ...
          <template slot="footer">今日ユーザー办決済金額：<span>{{ todayIBjl }}</span></template>
        </chart-card>
      </a-col>
    </a-row>
    ...
    <a-card :loading="loading" :bordered="false" :body-style="{padding: '0'}">
      <div class="salesCard">
        <a-tabs default-active-key="1" size="large" :tab-bar-style="{marginBottom: '24px', paddingLeft: '16px'}">
          ...
          <a-tab-pane loading="true" tab="受理管理" key="1">
            <a-row>
              ...
              <a-col :xl="8" :lg="12" :md="12" :sm="24" :xs="24">
                ...
                <a-card title="クイックスタート / 便利なナビゲーション" style="margin-bottom: 24px" :bordered="false" :body-style="{padding: 0}">

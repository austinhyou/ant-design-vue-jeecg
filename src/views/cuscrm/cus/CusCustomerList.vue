  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/cus/cusCustomer/list",
          delete: "/cus/cusCustomer/delete",
          deleteBatch: "/cus/cusCustomer/deleteBatch",
          exportXlsUrl: "/cus/cusCustomer/exportXls",
          importExcelUrl: "cus/cusCustomer/importExcel",
